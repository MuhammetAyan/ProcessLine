...
class ProcessInput:
    ...
    def __init__(self, filename:str, type: ProcessIOType) -> None:
        ...
        self._fs = None
        self._canRead = False
        self.firstRowIsHeader: bool = True
        self.header = None
    ...
    def load(self) -> None:
        ...
        if self.firstRowIsHeader:
            self.header = self._generator(*self._gen_args)
...
class ProcessOutput:
    ...
    def __init__(self, filename:str, type: ProcessIOType) -> None:
        ...
        self.firstRowIsHeader: bool = False
        self.header = None
    ...
    def write(self, row: object) -> None:
        ...
        try:
            ...
            self._canWrite = False
            raise ProcessError("ProcessOutput.write error: " + e)
